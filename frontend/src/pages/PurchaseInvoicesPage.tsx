        ...
        <Modal isOpen={!!invoice} onClose={onClose} title={`تفاصيل فاتورة المشتريات: ${invoice.invoiceNumber}`}>
            <div className="print-container space-y-6 max-h-[75vh] overflow-y-auto pr-1">
                <div className="grid grid-cols-2 gap-4 bg-slate-950/60 print:bg-white p-4 rounded-xl border border-slate-800 print:border-slate-300 text-sm">
                    ...
                    <div>
                        <span className="text-slate-400 print:text-slate-600 block text-xs">المورد</span>
                        <span className="font-semibold text-slate-200 print:text-slate-900">{invoice.supplierName}</span>
                    </div>
                    <div>
                    ...
                    <div>
                        <span className="text-slate-400 print:text-slate-600 block text-xs">المبلغ المدفوع</span>
                            ...
                            <tbody className="divide-y divide-slate-800/60 print:divide-slate-300 text-slate-300 print:text-slate-900">
                                {invoice.items.map(item => (
                                    <tr key={item.id} className="hover:bg-slate-950/30">
                                        ...
                                        <td className="p-2.5 text-slate-300 print:text-slate-900">{item.unitCost.toFixed(2)}</td>
